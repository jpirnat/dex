...
class MoveModel
{
	...
	public function setData(
		...
		$movesetRatedMoves = $this->movesetRatedMoveRepository->getByMonthAndFormatAndRatingAndPokemon(
			$thisMonth,
			$formatId,
			$rating,
			$pokemonId
		...
		$prevMonthMoves = $this->movesetRatedMoveRepository->getByMonthAndFormatAndRatingAndPokemon(
			$prevMonth,
			$formatId,
			$rating,
			$pokemonId
